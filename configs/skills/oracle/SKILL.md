...
metadata: {"nexus":{"emoji":"🧿","requires":{"bins":["oracle"]},"install":[{"id":"node","kind":"node","package":"@steipete/oracle","bins":["oracle"],"label":"Install oracle (node)"}]}}
---
...
- Model: GPT‑5.2 Pro (`--model gpt-5.3-pro` or `--model "5.2 Pro"`)
